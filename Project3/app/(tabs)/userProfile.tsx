...
const UserProfile = () => {
  ...
  // Run fetchUserData when component mounts or when refreshTimestamp changes
  useEffect(() => {
    fetchUserData();
  }, [refreshTimestamp]);
      ...
      try {
        ...
        if (username) {
          setUserData({
            id: userId || '',
            username: username || '',
            email: userData.email // Keep existing email if available
          });
  ...
  const handleUsernameUpdate = async () => {
    ...
    try {
      ...
      // Implement the API endpoint in your Spring Boot backend
